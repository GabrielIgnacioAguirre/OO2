...
public abstract class SingleThreadTCPServer {
    ...
    private final void handleClient(Socket clientSocket) {
        ...
        try (
            ...
            while ((inputLine = in.readLine()) != null) {
            	this.ReceivedMessage(inputLine, clientSocket);
    ...
    protected boolean shouldCloseConnection(String msg) {
        return msg.equals("");
    }
    ...
    protected void ReceivedMessage(String inputLine, Socket clientSocket) {
